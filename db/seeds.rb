...
mission2 = Mission.new(
  ...
  city: "Nantes",
  datetime: DateTime.parse("2020-01-09 17:00"),
  duration: 1,
...
mission4 = Mission.new(
  ...
  city: "Nantes",
  datetime: DateTime.parse("2020-05-6 18:45"),
  duration: 3,
  ...
  address: "5 rue des bas moulins, 44800 Saint-Herblain",
  mincapacity: 2,
  maxcapacity: 3,
  supernova: user1,
  partner: partner4,
...
mission16 = Mission.new(
  ...
  cause: "Lien intergénérationnel",
  address: "14 Allée du Parc des Mahaudières, 44400 Rezé",
  mincapacity: 1,
  maxcapacity: 4,
  supernova: user2,
  partner: partner8,
...
mission17 = Mission.new(
  ...
  city: "Nantes",
  datetime: DateTime.parse("2020-04-9 14:15"),
  duration: 1,
  ...
  cause: "Lien intergénérationnel",
  address: "15 Rue du Raffuneau, 44700 Orvault",
  mincapacity: 1,
  maxcapacity: 3,
  supernova: user3,
  partner: partner12,
...
mission6.remote_picture_url = "https://scontent-cdt1-1.xx.fbcdn.net/v/t31.0-8/27164023_354564671619841_8747964910346247855_o.jpg?_nc_cat=101&_nc_ohc=1D3RAkvhGBcAQkbqTal1w6YCgsWED1cbco9Gv1zDRW59V94PPVL9fvgpw&_nc_ht=scontent-cdt1-1.xx&oh=f12c07830bea523f04e471387c2c036d&oe=5E8121AA"
mission6.save!

mission18 = Mission.new(
  title: "Apprentissage du numérique",
  city: "Nantes",
  datetime: DateTime.parse("2019-12-12 19:00"),
  duration: 2,
